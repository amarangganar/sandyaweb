...
@section('title', 'Capacity Programme with UNHCR')
  ...
  <div class="pb-24">
    <div class="max-w-5xl mx-auto px-6">
      <div class="grid">
        ...
        @for ($i = 1; $i <= 18; $i++)
        <div class="grid-item">
          <a data-fancybox="gallery" href="{{ asset('img/gallery/unhcr/'.$i.'-min.jpg') }}">
            <img src="{{ asset('img/gallery/unhcr/'.$i.'-min.jpg') }}" />
          </a>
        </div>
        @endfor
      </div>
    ...
    <div class="max-w-5xl mx-auto px-6 mt-8">
      <p class="text-gray-700 text-center text-base font-medium"><a href="https://drive.google.com/drive/folders/1oasVFkCPKsjN6FgSQMHt4HTybw1lVlzg" target="_blank" class="text-gray-700 text-base font-medium"
